...
24 print "{down}{down}        press any key to start":p=2000:gosub187
...
!- my precious
181print"he had a magic ring marked ";:goto182+int(rnd(1)*3)
!- zap ring
...
190goto188
!- data
191data"nothing","werewolf","bunyip","phoenix","troll","goblin","giant","gorgon"
192data"dragon","ogre","wizard","fiendish","green","foul","slimy","tough"
193data"horrible","hungry","nasty","dirty","{cm +}"," ","{reverse on} {reverse off}"," ","S","x"